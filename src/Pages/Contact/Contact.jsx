                ...
                <div className='w-full pb-28 lg:pb-0'>
                    <div >
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5'>   
                            <div className={isDarkMode ? 'bg-gray-900/80 space-y-2 p-8 shadow-lg' :'bg-gray-300 space-y-2 p-8 shadow-lg'}>
                                <div className='flex justify-between items-center'>
                                    <p className=' fonr-bold'>Email:</p>
                                    <p className=' fonr-semibold '>nafizalturabi@gmail.com</p>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <p className=' fonr-bold'>Whatsapp:</p>
                                    <p className=' fonr-semibold '>+880 1747-206719</p>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <p className=' fonr-bold'>Skype:</p>
                                    <p className=' fonr-semibold '>mridul</p>
                                </div>
                            </div>
                            <div className={isDarkMode ? 'bg-gray-900/80 space-y-2 p-8 shadow-lg' :'bg-gray-300 space-y-2 p-8 shadow-lg'}>
                                <div className='flex justify-between items-center'>
                                    <p className=' fonr-bold'>Phone:</p>
                                    <p className=' fonr-semibold '>+880 1755-659843</p>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <p className=' fonr-bold'>Phone-2:</p>
                                    <p className=' fonr-semibold '>+880 1747-206719</p>
                                </div>
                        ...
                        <form className={isDarkMode ? 'bg-gray-900/80 px-5 py-10 space-y-10' : 'bg-gray-300 px-5 py-10 space-y-10'}>
                            <div className='flex items-center'>
                                ...
                                <input
                                    ...
                                    type="name" name="name" id="" className='bg-gray-700/10 placeholder:text-gray-600 w-full p-3 focus:outline-none' placeholder='Name' />
                            </div>
                            <div className='flex items-center'>
                                ...
                                <input
                                    ...
                                    type="email" name="email" id="" className='bg-gray-700/10 placeholder:text-gray-600 w-full p-3 focus:outline-none' placeholder='Email' />
                            </div>
                            <div className='flex '>
                                ...
                                <textarea
                                    ...
                                    type="text" name="message" id="" className='bg-gray-700/10 placeholder:text-gray-600 w-full h-32 p-3 focus:outline-none' placeholder='Message' />
                            </div>
